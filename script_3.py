# Criar o arquivo pdf-generator.js para geração de PDFs
pdf_generator_js = '''// PDF Generator for Solar Calculator
class PDFGenerator {
    constructor() {
...
with open('pdf-generator.js', 'w', encoding='utf-8') as f:
    f.write(pdf_generator_js)

print("✅ pdf-generator.js criado com sucesso!")